...
public class ChatActivity extends AppCompatActivity {
    ...
    private static final int GALLARY_PICK=1995;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMessageAdapter = new MessageAdapter(messagesList,this,mChatUser);
        //
    ...
    private void loadMessages() {
        DatabaseReference messageRef=mRootRef.child("messages").child(mCurrentUserId).child(mChatUser);
        Query messageQuery=messageRef.limitToLast(mCurrent_page * TOTAL_ITEMS_TO_LOAD);

        messageQuery.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Log.d("Datasnap", "onChildAdded: " + dataSnapshot.getValue().toString());
                //Messages message=dataSnapshot.getValue(Messages.class);
                Messages message = dataSnapshot.getValue(Messages.class);
                itemPos++;
                if(itemPos==1){
